...
async function subscribeToPush() {
    ...
    try {
        ...
        const subscription = await registration.pushManager.subscribe({
            ...
            applicationServerKey: urlBase64ToUint8Array('BAhmoZzyq8gEicS_5OM5zXSbpW3dAKmjCZNgllHv0EhL3dUGx77Ce8UriGf-GpPKqkppSSqxowyTFMHCAVKJXfY')
        });
...
${date.toLocaleString()}</small>`;
            ...
            return `<li class="card" style="margin-bottom: 0.5rem; padding:
0.5rem;">
